...
def clean_url(filename):
    ...
    An example of a url in the column is: "[align=center][img]http://i.imgur.com/88g2N.png[/img]rn[url=http://www.loungeboard.net/showthread.php?tid=232]Lounge Board Rules & Etiquette[/url] | [url=http://www.loungeboard.net/showthread.php?tid=36]Premium Upgrade Information[/url] [/align]"
