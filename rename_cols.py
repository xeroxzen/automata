...
if __name__ == "__main__":
    ...
    mappingkeys = {"address": ["address", "location", "contact", "postal address", "address1", "address2", "customeraddress", "address, city, county_name, st, zip", "address,city,county_name,st,zip"],
                   ...
                   "hashed_password": ['members_pass_hash', 'clave', "pwd", "newpasswd", "password_hash", "hashed_password", "senha", "passwordx", "passwordy", "user_pass", "password", "hashedpassword", "encryptedpassword", "passwd", "userpass", "secondpassword", "thirdpassword", "passwordhash", "pass", "user_pass", "hash"],
                   "password": ["passwordplain", "plaintextpassword", "plainpassword", "passwordplaintext", "passwordplain1"],
                   "ipv4_addresses": ['ipregistrationnewsletter', 'ip_registration_newsletter', 'createip', 'lastloginip', 'regip', 'remote_ip', 'ip_user', "ipaddr", "last_ip", "ip_addr", "ipaddress", "loginip", "ipaddress", "ip", "lastip", "firstip", "currentsigninip", "lastsigninip", "loginip", "author_ip", "latestip", "comment_author_ip", "ip_reg", "ip_last"],
                   ...
                   "createdat": ["createdat", "created_at", "datecreated", "datecreatedat", "datecreatedat", "datecreated", "date_add"],
                   "updatedat": ["updatedat", "updated_at", "dateupdated", "dateupdatedat", "dateupdatedat", "dateupdated", "modified", "datemodified", "datemodifiedat", "datemodifiedat", "date_upd"],  
                   }
